  ...
  if (falta === 0) {
    ...
    if (holgura >= 20) {
      acciones.push({
        ...
        texto: `Sobra margen: puedes llevar ${eur(holgura * 0.6)}/mes más a inversión y seguir llegando a tiempo.`,
      })
    }
    ...
    if (deInversion > 0) {
      acciones.push({
        ...
        texto: `Baja la aportación a inversión ${eur(deInversion)}/mes hasta llegar al objetivo. Es reversible y no quema dinero.`,
      })
    }
