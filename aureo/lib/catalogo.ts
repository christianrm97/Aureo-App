...
/**
 * Tipos de proyecto habituales. No es una lista cerrada: 'otro' deja registrar
 * cualquier proyecto sin tocar el codigo.
 */
export const TIPOS_PROYECTO: TipoProyecto[] = [
  { id: 'tienda',    nombre: 'Tienda online', icono: 'store',     color: '#EC4899', bg: '#FCE7F3' },
  { id: 'trading',   nombre: 'Trading',       icono: 'linechart', color: '#22C55E', bg: '#DCFCE7' },
  { id: 'app',       nombre: 'App o SaaS',    icono: 'trophy',    color: '#3B82F6', bg: '#DBEAFE' },
  { id: 'otro',      nombre: 'Otro',        icono: 'sparkles',  color: '#9A93A8', bg: '#ECE7F1' },
]
