...
export default function Privacidad() {
  return (
    <PaginaLegal titulo="Política de privacidad"
      ...
      <p>
        El responsable del tratamiento es <strong><Dato valor={LEGAL.responsable} /></strong>, con NIF{' '}
      ...
      <ul>
        ...
        <li><strong>Informes del Vigilante de gastos</strong>, solo si decides guardarlos: comercios, importes, frecuencias y conclusiones del análisis. Nunca el extracto bancario completo.</li>
        <li><strong>Datos técnicos</strong>: dirección IP y tipo de navegador en los registros del servidor, por seguridad.</li>
      </ul>
      <p>
        Aureo <strong>no se conecta a tu banco</strong> ni pide credenciales bancarias. Los datos
        económicos los introduces tú. Si usas el Vigilante de gastos, el extracto CSV se analiza en
        tu navegador y <strong>no se envía a nuestros servidores</strong>.
      </p>
      ...
      <p>
        Mientras tengas la cuenta activa. Si la eliminas desde Ajustes → Tus datos, tus datos económicos,
        tus informes y tu perfil se borran en ese momento, salvo los registros que debamos conservar
        por obligación legal.
      </p>

      <h2>6. Tus derechos</h2>
      <p>
        Puedes <strong>descargar todos tus datos</strong> (portabilidad) y <strong>eliminar tu cuenta</strong>
        (supresión) tú mismo desde Ajustes → Tus datos. Para acceso, rectificación, limitación u oposición,
        o si prefieres hacerlo por escrito, escribe a <a href={`mailto:${LEGAL.email}`}>{LEGAL.email}</a>. Te responderemos en un
