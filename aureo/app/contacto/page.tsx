...
export default function Contacto() {
  return (
    <PaginaLegal titulo="Contacto" subtitulo="Una persona lee todo lo que llega.">
      ...
      <ul>
        <li><strong>Titular:</strong> <Dato valor={LEGAL.responsable} /></li>
      ...
      <ul>
        <li><strong>¿Aureo se conecta a mi banco?</strong> No. Los saldos los introduces tú, y los movimientos puedes importarlos desde el CSV de tu banco.</li>
        <li><strong>¿Puedo borrar mi cuenta?</strong> Sí, tú mismo desde Ajustes → Tus datos, con todo lo que contiene. Antes puedes descargarlos.</li>
        <li><strong>¿Esto es asesoramiento financiero?</strong> No. Es una herramienta de cálculo; las decisiones son tuyas.</li>
      </ul>
      <p>Más respuestas en las <a href="/faq">preguntas frecuentes</a>.</p>
    </PaginaLegal>
  )
}
